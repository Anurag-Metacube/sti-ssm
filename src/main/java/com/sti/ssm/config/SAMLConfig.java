...
//import com.sti.ssm.certificate.KeystoreFactory;
//import com.sti.ssm.config.security.SAMLUserDetailsServiceImpl;
...
//        KeyStore keystore = keystoreFactory.loadKeystore("classpath:/saml/localhost.cert", "classpath:/saml/localhost.key.der", "localhost", "");
